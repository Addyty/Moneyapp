...
public class ManagerCreate {
    public static void main(String[] args) {
        String Username = "Addy67";
        String EmpId = "2056";
        String Fullname = "Aaditya Tyagi";
        ...
        String Password = "Tyagi67@#";
        String CnfPassword = "Tyagi67@#";
    ...
    Class.forName("com.mysql.jdbc.Driver");
           ...
           String filename = "<Picture Absolute Path>";  // Eor example Let your picture is present in the folder named Picture in the D drive, then the file path will be: 'D:/Picture/abc.jpg'
